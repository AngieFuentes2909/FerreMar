...
.btn-clear{padding:10px 16px;border-radius:8px;border:1.5px solid #e5e7eb;background:white;color:#555;font-size:13px;font-weight:500;cursor:pointer;display:flex;align-items:center;gap:6px}
...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-search-dollar fa-fw" style="color:#f97316"></i> &nbsp; Buscar ventas</div>
  </div>
  ...
  <form class="FormularioAjax search-form" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off">
    ...
    <input class="search-input" type="text" name="txt_buscador" placeholder="Código de venta..." maxlength="30" required>
