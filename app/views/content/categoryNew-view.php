...
<div class="form-card">
  <div class="form-card-title"><i class="fas fa-tag fa-fw" style="color:#f97316"></i> &nbsp; Nueva categoría</div>
  <div class="form-card-subtitle">Crea una nueva categoría para organizar los productos del inventario</div>
  ...
  <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/categoriaAjax.php" method="POST" autocomplete="off">
    ...
    <div class="form-grid form-grid-2">
      <div class="form-group">
        ...
        <input type="text" name="categoria_nombre" placeholder="Ej: Herramientas" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" required>
      </div>
      <div class="form-group">
        <label>Ubicación en bodega</label>
        <input type="text" name="categoria_ubicacion" placeholder="Ej: Estante A, pasillo 3" maxlength="150">
      </div>
    </div>

    <div class="form-actions">
      <button type="reset" class="btn-reset"><i class="fas fa-undo"></i> Limpiar</button>
      <button type="submit" class="btn-save"><i class="far fa-save"></i> Guardar categoría</button>
    </div>
