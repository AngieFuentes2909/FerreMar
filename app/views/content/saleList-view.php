...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-shopping-cart fa-fw" style="color:#f97316"></i> &nbsp; Lista de ventas</div>
    <a href="<?php echo APP_URL; ?>saleNew/" class="btn-new"><i class="fas fa-plus"></i> Nueva venta</a>
  </div>
  <?php
