...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-cubes fa-fw" style="color:#f97316"></i> &nbsp; Lista de productos</div>
    <a href="<?php echo APP_URL; ?>productNew/" class="btn-new"><i class="fas fa-plus"></i> Nuevo producto</a>
  </div>
  <?php
