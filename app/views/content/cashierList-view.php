...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-cash-register fa-fw" style="color:#f97316"></i> &nbsp; Lista de cajas</div>
    <a href="<?php echo APP_URL; ?>cashierNew/" class="btn-new"><i class="fas fa-plus"></i> Nueva caja</a>
  </div>
  <?php
