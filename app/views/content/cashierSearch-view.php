...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-search fa-fw" style="color:#f97316"></i> &nbsp; Buscar cajas</div>
  </div>
  ...
  <form class="FormularioAjax search-form" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off">
    ...
    <input class="search-input" type="text" name="txt_buscador" placeholder="Buscar por nombre o número..." maxlength="30" required>
  ...
  <br>
  <?php echo $insCaja->listarCajaControlador($url[1], 15, $url[0], $_SESSION[$url[0]]); ?>
