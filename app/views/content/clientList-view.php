...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-address-book fa-fw" style="color:#f97316"></i> &nbsp; Lista de clientes</div>
    <a href="<?php echo APP_URL; ?>clientNew/" class="btn-new"><i class="fas fa-plus"></i> Nuevo cliente</a>
  </div>
  <?php
