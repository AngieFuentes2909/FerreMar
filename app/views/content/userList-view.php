...
<div class="list-card">
  <div class="list-card-header">
    <div class="list-card-title"><i class="fas fa-users fa-fw" style="color:#f97316"></i> &nbsp; Lista de usuarios</div>
    <a href="<?php echo APP_URL; ?>userNew/" class="btn-new"><i class="fas fa-plus"></i> Nuevo usuario</a>
  </div>
  <?php
