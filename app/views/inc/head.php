...
<link rel="icon" type="image/png" href="<?php echo APP_URL; ?>app/views/img/logo.png?v=1.0">
...
<link rel="stylesheet" href="<?php echo APP_URL; ?>app/views/css/estilos.css?v=1.0">
